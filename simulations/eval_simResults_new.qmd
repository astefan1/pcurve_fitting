...
```{r}
# Worst case, optional stopping
simres |> filter(condition == "optStop_worst") |> arrange(fit_pcurve2_g2) |> slice(1:5) |> select(c(1:9, 10:14), fit_pcurve2_g2) |> round(2) |> print()
```
...
```{r}
# Realistic, optional stopping
simres |> filter(condition == "optStop_realistic") |> arrange(fit_pcurve2_g2) |> slice(1:5) |> select(c(1:9, 10:14), fit_pcurve2_g2) |> round(2) |> print()
```
