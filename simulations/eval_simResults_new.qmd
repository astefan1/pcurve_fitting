...
simres |> filter(condition == "optStop_worst") |> arrange(fit_pcurve1_g2) |> slice(1:10) |> select(c(1:9, 10:15), fit_pcurve1_g2) |> round(2) |> print()
```
...
simres |> filter(condition == "optStop_realistic") |> arrange(fit_pcurve1_g2) |> slice(1:10) |> select(c(1:9, 10:15), fit_pcurve1_g2) |> round(2) |> print()
```
