...
# TODO: Some chi2 could not be computed, as some p-curve bins were exactly zero.
...
# cor(simres$rmseSotola, simres$chi2Sotola, use="p")
# plot(simres$rmseSotola, simres$chi2Sotola)
# cor(simres$rmseWetzels, simres$chi2Wetzels, use="p")
# cor(simres$rmseSimonsohn, simres$chi2Simonsohn, use="p")
