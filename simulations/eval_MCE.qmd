...
In the first plot, we did 10,000 iterations in the simulation function. That means, each of the 1000 blue *p*-curves is the average of **10,000** simulations of the same condition. The MCE of the fith *p*-value bin was `r sd(simres_10000$p5) |> round(2)`.
