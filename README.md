...
This repository contains the code to fit a p-curve to the results of [Clarke et al. (2026)](https://doi.org/10.31234/osf.io/txzeu_v1). Specifically, in this project we fit simulated p-curves to two empirical p-curves from Clarke et al. (2026): one p-curve of experiments published in Social Psychological and Personality Science (SPPS) between 2010 and 2012 and a second p-curve of experiments published at SPPS between 2016 and 2019.
...
In the simulated data, the **p-value selection strategies** are: 
